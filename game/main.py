...
musique_menu = pygame.mixer.Sound("audio/musique_menu.ogg")
musique_level_1 = pygame.mixer.Sound("audio/musique_level_1.ogg")
musique_level_2 = pygame.mixer.Sound("audio/musique_level_2.ogg")
musique_level_3 = pygame.mixer.Sound("audio/musique_level_3.ogg")
musique_level_4 = pygame.mixer.Sound("audio/musique_level_4.ogg")
musique_level_5 = pygame.mixer.Sound("audio/musique_level_5.ogg")

# Fonction utilitaire pour arrêter toutes les musiques
def stop_all_music():
    musique_menu.stop()
    musique_level_1.stop()
    musique_level_2.stop()
    musique_level_3.stop()
    musique_level_4.stop()
    musique_level_5.stop()
...
perso_face = [pygame.transform.scale(pygame.image.load("Images/perso_face.png"), (40, 40)) for _ in range(3)]
perso_face_marche = [pygame.transform.scale(pygame.image.load("Images/perso_face_marche.png"), (40, 40)) for _ in range(3)]
perso_face_marche2 = [pygame.transform.scale(pygame.image.load("Images/perso_face_marche2.png"), (40, 40)) for _ in range(3)]

perso_dos = [pygame.transform.scale(pygame.image.load("Images/perso_dos.png"), (40, 40)) for _ in range(3)]
perso_dos_marche = [pygame.transform.scale(pygame.image.load("Images/perso_dos_marche.png"), (40, 40)) for _ in range(3)]
perso_dos_marche2 = [pygame.transform.scale(pygame.image.load("Images/perso_dos_marche2.png"), (40, 40)) for _ in range(3)]

perso_profil_droit = [pygame.transform.scale(pygame.image.load("Images/perso_profil_droit.png"), (40, 40)) for _ in range(3)]
perso_profil_droit_marche = [pygame.transform.scale(pygame.image.load("Images/perso_profil_droit_marche.png"), (40, 40)) for _ in range(3)]
perso_profil_droit_marche2 = [pygame.transform.scale(pygame.image.load("Images/perso_profil_droit_marche2.png"), (40, 40)) for _ in range(3)]

perso_profil_gauche = [pygame.transform.scale(pygame.image.load("Images/perso_profil_gauche.png"), (40, 40)) for _ in range(3)]
perso_profil_gauche_marche = [pygame.transform.scale(pygame.image.load("Images/perso_profil_gauche_marche.png"), (40, 40)) for _ in range(3)]
perso_profil_gauche_marche2 = [pygame.transform.scale(pygame.image.load("Images/perso_profil_gauche_marche2.png"), (40, 40)) for _ in range(3)]
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                if play_button_rect.collidepoint(event.pos):
                    stop_all_music()
                    play_game(1, charger_labyrinthe(1))
...
def play_game(niveau, lab):
    ...
    portes, clefs = dessiner_labyrinthe(lab, niveau)

    stop_all_music()
    if niveau == 1: musique_level_1.play(-1)
    if niveau == 2: musique_level_2.play(-1)
    if niveau == 3: musique_level_3.play(-1)
    if niveau == 4: musique_level_4.play(-1)
    if niveau == 5: musique_level_5.play(-1)
        ...
        for clef_rect in clefs[:]:
            if personnage.colliderect(clef_rect):
                if clef_rect not in clefs_prises:
                    effet_clef.play()
                    clefs_prises.append(clef_rect)
                clefs.remove(clef_rect)

        # Collision porte
        for porte_rect in portes:
            if personnage.colliderect(porte_rect):
                if len(clefs_prises) > 0:
                    stop_all_music()
                    choisir_niveau()
